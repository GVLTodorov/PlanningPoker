...
if (app.Environment.IsDevelopment())
{
    ...
    // edit-rebuild-refresh cycle -- exactly what was happening. Blanket no-cache sidesteps that
    // entirely for every response while debugging; production keeps the long-cache-for-hashed-files
    // strategy below untouched.
