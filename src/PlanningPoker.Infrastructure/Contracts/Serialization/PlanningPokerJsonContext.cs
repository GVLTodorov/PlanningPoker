...
/// reflection-based serialization on the hottest path in the app (every pick/reveal fans out to
/// every connected player).
/// </summary>
[JsonSourceGenerationOptions(
    PropertyNamingPolicy = JsonKnownNamingPolicy.CamelCase,
    UseStringEnumConverter = true)]
[JsonSerializable(typeof(CardOptionResponse))]
[JsonSerializable(typeof(DeckResponse))]
[JsonSerializable(typeof(IReadOnlyList<DeckResponse>))]
[JsonSerializable(typeof(PlayerResponse))]
[JsonSerializable(typeof(RoomStateResponse))]
[JsonSerializable(typeof(RoomSummaryResponse))]
